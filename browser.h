...
protected:
  browser() : default_page( "http://www.google.com/" )
  {
  } //singleton
...
public:
  void create( browser_instance& w, const mm::uvec2& screen, bool managed = false );
  ...
  void resize( browser_instance& w, const mm::uvec2& screen );
  ...
  void mouse_moved( const browser_instance& w, const mm::vec2& pos )
  {
